...
var salesApp = new Vue({
  ...
  data: {
    ...
    yearSelected: "",
    statusSelected: "",
    filtering: false, // Atributo booleano que indica si se están filtrando los autos.
  },
  filters: {
 ...
 *
 * Nota: para detectar eventos podría haber usado Vue.js
 * (en lugar de jQuery).
 ...
 *
 * Nota: para detectar eventos también podría haber usado Vue.js
 * (en lugar de jQuery).
 * Documentación: https://vuejs.org/v2/guide/events.html
 */
 ...
 * CARGA DE AUTOS.
 *
 * Esta función se llama tanto al cargar la página por primera vez,
